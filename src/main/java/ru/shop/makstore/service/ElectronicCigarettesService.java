...
public final class ElectronicCigarettesService implements ElectronicCigarettesInterface{
    ...
    public ElectronicCigarettes editElectronicCigarettes(
            ElectronicCigarettes electronicCigarettes) {
        int id = electronicCigarettes.getId();
    ...
    @Override
    public void deleteElectronicCigarettes(int id) {
        try {
            electronicCigarettesRepository.findById(id)
                    .ifPresentOrElse(
                            vape -> electronicCigarettesRepository.deleteById((int) vape.getId()),
                            () -> {
    ...
    @Override
    public ElectronicCigarettes findElectronicCigarette(int id) {
