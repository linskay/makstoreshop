...
public class ElectronicCigarettesController {
    ...
    public ElectronicCigarettesController(ElectronicCigarettesService electronicCigarettesService,
    ...
    @GetMapping("{id}")
    public ResponseEntity<ElectronicCigarettes> getElectronicCigarettesInfo(@PathVariable int id) {
    ...
    @DeleteMapping("{id}")
    public ResponseEntity deleteElectronicCigarettes(@PathVariable int id) {
    ...
    public ResponseEntity<String> addCover(@PathVariable int id,
